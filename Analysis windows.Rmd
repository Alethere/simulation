...
summary(sim_sw@Tajima.D);summary(sim_sw@theta_Tajima);summary(sim_sw@theta_Watterson)
broom(lapply(get.neutrality(sim_sw,theta=T),summary))
lapply(c(sim_sw@theta_Tajima, sim_sw@theta_Watterson, sim_sw@Tajima.D),summary)
```
